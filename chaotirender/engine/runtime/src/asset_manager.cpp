...
{   
    bool AssetManagerOld::loadAsset(std::string asset_path)
    {
    ...
    // void AssetManagerOld::getObjectResource(std::string asset_path, RenderObjectResource& resource)
    // {   
    ...
    // void AssetManagerOld::getTextureData(RenderObjectResource& object_resource)
    // {
    ...
    // void AssetManagerOld::getMeshData(RenderObjectResource& object_resource)
    // {
    ...
    uint8_t* AssetManagerOld::loadRawTexture(std::string file, int& w, int&h, int& n)
    {
